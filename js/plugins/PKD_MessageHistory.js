...
/*:
 * @plugindesc (v.1.0)[BASIC] Message History
 * @author Pheonix KageDesu
 * @target MZ MV
 * @url https://kdworkshop.net/plugins/message-history/
 ...
 *
 * GUIDE:
 * https://gist.github.com/KageDesu/69c991a123c7fc8e5307f1408c416b23
 *
 * ---------------------------------------------------------------------------
 ...
 * License: Creative Commons 4.0 Attribution, Share Alike, Non-Commercial
 * 
 * @param PKD_MessageHistory
 * 
 * 

 * 
 * 
 * @param getMaxHistorySize:int
 * @parent PKD_MessageHistory
 * @text Max History Size
 * @type number
 * @default 25
 * @desc Maximum size of history list
 * 
 * 

 * 
 * 
 * @param isAutoRemoveLastDuplicate:b
 * @parent PKD_MessageHistory
 * @text Auto Remove Last Duplicate
 * @type boolean
 * @default true
 * @desc Automatically remove last duplicate message
 * 
 * 

 * 
 * 
 * @param isAddChoiceToHistory:b
 * @parent PKD_MessageHistory
 * @text Add Choice to History
 * @type boolean
 * @default true
 * @desc Add choice to history list
 * 
 * 

 * 
 * 
 * @param getChoiceHistoryMessageConfig:struct
 * @parent isAddChoiceToHistory:b
 * @text Choice History Message Config
 * @type struct<HistoryMessageConfig>
 * @default {"faceIndex:int":"0","faceName":"","speakerName":"Answer","textFormat":" \\C[1]>>\\C[0] {0}"}
 * @desc Configuration for choice message
 * 
 * 

 * 
 * 
 * @param isAddHistoryButtonToScreen:b
 * @parent PKD_MessageHistory
 * @text Add History Button to Screen
 * @type boolean
 * @default true
 * @desc Add history button to screen
 * 
 * 

 * 
 * 
 * @param isShowHistoryButtonInsideMessage:b
 * @parent isAddHistoryButtonToScreen:b
 * @text Show History Button Inside Message
 * @type boolean
 * @default true
 * @desc Show history button inside message window
 * 
 * 

 * 
 * 
 * @param isShowHistoryButtonOutsideMessage:b
 * @parent isAddHistoryButtonToScreen:b
 * @text Show History Button Outside Message
 * @type boolean
 * @default true
 * @desc Show history button outside message window
 * 
 * 

 * 
 * 
 * @param isCanOpenHistoryMessageInsideMessage:b
 * @parent isAddHistoryButtonToScreen:b
 * @text Can Open History Message Inside Message
 * @type boolean
 * @default true
 * @desc Can open history message inside message window
 * 
 * 

 * 
 * 
 * @param isCanOpenHistoryMessageOutsideMessage:b
 * @parent isAddHistoryButtonToScreen:b
 * @text Can Open History Message Outside Message
 * @type boolean
 * @default true
 * @desc Can open history message outside message window
 * 
 * 

 * 
 * 
 * @param isAddHistoryButtonToMenu:b
 * @parent PKD_MessageHistory
 * @text Add History Button to Menu
 * @type boolean
 * @default true
 * @desc Add history button to menu
 * 
 * 

 * 
 * 
 * @param menuHistoryButtonTitle
 * @parent isAddHistoryButtonToMenu:b
 * @text Menu History Button Title
 * @type text
 * @default Message History
 * @desc Title for history button in menu
 * 
 * 
 ...
 * @param getMaxHistorySize:int
 * @parent PKD_MessageHistory
 * @text Максимальный размер истории
 * @type number
 * @default 25
 * @desc Максимальный размер списка истории
 * 
 * 
 ...
 * @param isAutoRemoveLastDuplicate:b
 * @parent PKD_MessageHistory
 * @text Автоматически удалять последний дубликат
 * @type boolean
 * @default true
 * @desc Автоматически удалять последнее дублирующее сообщение
 * 
 * 
 ...
 * @param isAddChoiceToHistory:b
 * @parent PKD_MessageHistory
 * @text Добавлять выбор в историю
 * @type boolean
 * @default true
 * @desc Добавлять выбор в список истории
 * 
 * 
 ...
 * @param getChoiceHistoryMessageConfig:struct
 * @parent isAddChoiceToHistory:b
 * @text Конфигурация сообщения выбора
 * @type struct<HistoryMessageConfig>
 * @default {"faceIndex:int":"0","faceName":"","speakerName":"Answer","textFormat":" \\C[1]>>\\C[0] {0}"}
 * @desc Конфигурация для сообщения выбора
 * 
 * 
 ...
 * @param isAddHistoryButtonToScreen:b
 * @parent PKD_MessageHistory
 * @text Добавить кнопку истории на экран
 * @type boolean
 * @default true
 * @desc Добавить кнопку истории на экран
 * 
 * 
 ...
 * @param isShowHistoryButtonInsideMessage:b
 * @parent isAddHistoryButtonToScreen:b
 * @text Показать кнопку истории внутри сообщения
 * @type boolean
 * @default true
 * @desc Показать кнопку истории внутри окна сообщения
 * 
 * 
 ...
 * @param isShowHistoryButtonOutsideMessage:b
 * @parent isAddHistoryButtonToScreen:b
 * @text Показать кнопку истории вне сообщения
 * @type boolean
 * @default true
 * @desc Показать кнопку истории вне окна сообщения
 * 
 * 
 ...
 * @param isCanOpenHistoryMessageInsideMessage:b
 * @parent isAddHistoryButtonToScreen:b
 * @text Можно открыть историю сообщений внутри сообщения
 * @type boolean
 * @default true
 * @desc Можно открыть историю сообщений внутри окна сообщения
 * 
 * 
 ...
 * @param isCanOpenHistoryMessageOutsideMessage:b
 * @parent isAddHistoryButtonToScreen:b
 * @text Можно открыть историю сообщений вне сообщения
 * @type boolean
 * @default true
 * @desc Можно открыть историю сообщений вне окна сообщения
 * 
 * 
 ...
 * @param isAddHistoryButtonToMenu:b
 * @parent PKD_MessageHistory
 * @text Добавить кнопку истории в меню
 * @type boolean
 * @default true
 * @desc Добавить кнопку истории в меню
 * 
 * 
 ...
 * @param menuHistoryButtonTitle
 * @parent isAddHistoryButtonToMenu:b
 * @text Заголовок кнопки истории в меню
 * @type text
 * @default Message History
 * @desc Заголовок для кнопки истории в меню
 * 
 * 
...
@param textFormat
@text Text Format
@desc Text format for message, {0} - message text

*/

/*~struct~HistoryMessageConfig:ru
...
@param textFormat
@text Формат текста
@desc Формат текста для сообщения, {0} - текст сообщения

*/

/*~struct~HistoryMessageConfig:zh-ch
...
var Imported;
(function (Imported) {
    Imported.PKD_MessageHistory = true;
})(Imported || (Imported = {}));
var PKD_MessageHistory;
(function (PKD_MessageHistory) {
    PKD_MessageHistory.Version = "1.0";
    /**
    ...
    */
    function GetNUIFile(name) {
        return window["$PKD_MessageHistory_" + name];
    }
    PKD_MessageHistory.GetNUIFile = GetNUIFile;
    /**
    ...
    */
    function Link(obj, name) {
        try {
            if ((name === null || name === void 0 ? void 0 : name.length) > 0) {
                PKD_MessageHistory[name] = obj;
            }
            else {
                let _name = obj.name;
                if ((_name === null || _name === void 0 ? void 0 : _name.length) > 0) {
                    PKD_MessageHistory[obj.name] = obj;
                }
                else {
    ...
    PKD_MessageHistory.Link = Link;
})(PKD_MessageHistory || (PKD_MessageHistory = {}));
...
(function (PP) {
    ...
    */
    function LoadPluginSettings() {
        _loader = new KDX.ParamLoader("PKD_MessageHistory");
    }
    ...
    */
    ...
    function getMaxHistorySize() {
        return getLoaderParam('getMaxHistorySize', 25);
    }
    PP.getMaxHistorySize = getMaxHistorySize;
    function getChoiceHistoryMessageConfig() {
        return getLoaderParam('getChoiceHistoryMessageConfig', {
            faceIndex: -1,
            faceName: "",
            speakerName: "Answer",
            textFormat: " \\C[1]>>\\C[0] {0}"
        });
    }
    PP.getChoiceHistoryMessageConfig = getChoiceHistoryMessageConfig;
    function isAddChoiceToHistory() {
        return getLoaderParam('isAddChoiceToHistory', true);
    }
    PP.isAddChoiceToHistory = isAddChoiceToHistory;
    function isAutoRemoveLastDuplicate() {
        return getLoaderParam('isAutoRemoveLastDuplicate', true);
    }
    PP.isAutoRemoveLastDuplicate = isAutoRemoveLastDuplicate;
    // * VISUAL BUTTON
    function isAddHistoryButtonToScreen() {
        return getLoaderParam('isAddHistoryButtonToScreen', true);
    }
    PP.isAddHistoryButtonToScreen = isAddHistoryButtonToScreen;
    function isShowHistoryButtonInsideMessage() {
        return getLoaderParam('isShowHistoryButtonInsideMessage', true);
    }
    PP.isShowHistoryButtonInsideMessage = isShowHistoryButtonInsideMessage;
    function isShowHistoryButtonOutsideMessage() {
        return getLoaderParam('isShowHistoryButtonOutsideMessage', true);
    }
    PP.isShowHistoryButtonOutsideMessage = isShowHistoryButtonOutsideMessage;
    function isCanOpenHistoryMessageInsideMessage() {
        return getLoaderParam('isCanOpenHistoryMessageInsideMessage', true);
    }
    PP.isCanOpenHistoryMessageInsideMessage = isCanOpenHistoryMessageInsideMessage;
    function isCanOpenHistoryMessageOutsideMessage() {
        return getLoaderParam('isCanOpenHistoryMessageOutsideMessage', true);
    }
    PP.isCanOpenHistoryMessageOutsideMessage = isCanOpenHistoryMessageOutsideMessage;
    // * MENU BUTTON
    function isAddHistoryButtonToMenu() {
        return getLoaderParam('isAddHistoryButtonToMenu', true);
    }
    PP.isAddHistoryButtonToMenu = isAddHistoryButtonToMenu;
    function menuHistoryButtonTitle() {
        return getLoaderParam('menuHistoryButtonTitle', 'Message History');
    }
    PP.menuHistoryButtonTitle = menuHistoryButtonTitle;
})(PP || (PP = {}));


const OpenMessageHistory = function () {
    try {
        if (!IsMessageHistoryAllowed()) {
            SoundManager.playBuzzer();
            return;
        }
        let isCanOpenMenuOutside = PP.isCanOpenHistoryMessageOutsideMessage();
        let isCanOpenMenuInside = PP.isCanOpenHistoryMessageInsideMessage();
        let isCanOpenMenu = false;
        let isEventRunning = $gameMap.isEventRunning();
        if (isCanOpenMenuInside && isCanOpenMenuOutside) {
            isCanOpenMenu = true;
        }
        else if (isCanOpenMenuInside && isEventRunning) {
            isCanOpenMenu = true;
        }
        else if (isCanOpenMenuOutside && !isEventRunning) {
            isCanOpenMenu = true;
        }
        if (!isCanOpenMenu) {
            SoundManager.playBuzzer();
...
window['OpenMessageHistory'] = OpenMessageHistory;
const OpenMessageHistoryScene = function () {
    try {
        SceneManager.push(Scene_MessageHistory);
    }
    catch (error) {
        console.warn(error);
    }
};
window['OpenMessageHistoryScene'] = OpenMessageHistoryScene;
const ClearMessageHistory = function () {
    try {
        PKD_MessageHistoryManager.ClearMessageHistory();
    }
    catch (error) {
        console.warn(error);
    }
...
const AllowWriteToMessageHistory = function () {
    try {
        /*@ts-ignore*/
        $gameSystem.pkdSetWriteToMessageHistory(true);
    }
    catch (error) {
        console.warn(error);
    }
};
window['AllowWriteToMessageHistory'] = AllowWriteToMessageHistory;
const DisallowWriteToMessageHistory = function () {
    try {
        /*@ts-ignore*/
        $gameSystem.pkdSetWriteToMessageHistory(false);
    }
    catch (error) {
        console.warn(error);
    }
};
window['DisallowWriteToMessageHistory'] = DisallowWriteToMessageHistory;
const AllowAccessToMessageHistory = function () {
    try {
        /*@ts-ignore*/
        $gameSystem.pkdSetAccessToMessageHistory(true);
    }
    catch (error) {
        console.warn(error);
    }
};
window['AllowAccessToMessageHistory'] = AllowAccessToMessageHistory;
const DisallowAccessToMessageHistory = function () {
    try {
        /*@ts-ignore*/
        $gameSystem.pkdSetAccessToMessageHistory(false);
    }
    catch (error) {
        console.warn(error);
    }
};
window['DisallowAccessToMessageHistory'] = DisallowAccessToMessageHistory;
const IsMessageHistoryAllowed = function () {
    try {
        /*@ts-ignore*/
        return $gameSystem.pkdIsCanAccessToMessageHistory();
    }
    catch (error) {
        console.warn(error);
    }
};
window['IsMessageHistoryAllowed'] = IsMessageHistoryAllowed;
...
(() => {
    ...
    function pkdRegisterLocalNUIFile(filnename) {
        KDNUI.RegisterNUIFile("PKD_MessageHistory", filnename);
    }
    pkdRegisterLocalNUIFile("NUI_MessageHistoryScene");
    pkdRegisterLocalNUIFile("NUI_MessageHistoryListItem");
    pkdRegisterLocalNUIFile("NUI_MessageHistoryScreenButton");
    //@[ALIAS]
    const ALIAS__loadDataFile = _.loadDataFile;
    _.loadDataFile = function (name, src) {
        if (src.includes("PKD_MessageHistory")) {
...
(() => {
    //@[DEFINES]
    const _ = Game_Message.prototype;
    //@[ALIAS]
    const ALIAS__onChoice = _.onChoice;
    _.onChoice = function (n) {
        if (KUtils.IsMapScene() || KUtils.IsBattleScene()) {
            PKD_MessageHistoryManager.AddChoiceToHistory(this._choices[n]);
        }
        ALIAS__onChoice.call(this, n);
    };
})();
// ■ END Game_Message.ts
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
/*let $gameSystemPMH = {
    pkdGetMessageHistoryData: () : PKD_MessageHistoryManager.HistoryMessage[] => { return [] },
};*/
(() => {
    //@[DEFINES]
    const _ = Game_System.prototype;
    _['pkdGetMessageHistoryData'] = function () {
        if (this._pkdMessageHistoryData === undefined) {
            this._pkdMessageHistoryData = [];
        }
        return this._pkdMessageHistoryData;
    };
    /*const pkdGetMessageHistoryData = function() : PKD_MessageHistoryManager.HistoryMessage[] {
        if(this._pkdMessageHistoryData === undefined) {
            this._pkdMessageHistoryData = [];
        }
        return this._pkdMessageHistoryData;
    ...
    $gameSystemPMH.pkdGetMessageHistoryData = () => pkdGetMessageHistoryData.call(_);*/
    //_['pkdGetMessageHistoryData'] = pkdGetMessageHistoryData;
    _['pkdAddMessageToHistory'] = function (message) {
        let data = this.pkdGetMessageHistoryData();
        if (KDX.any(message)) {
            data.push(message);
        }
    };
    _['pkdClearMessageHistory'] = function () {
        this._pkdMessageHistoryData = [];
    };
    _['pkdSetWriteToMessageHistory'] = function (value) {
        this._pkdWriteToMessageHistory = value;
    };
    _['pkdIsCanWriteToHistory'] = function () {
        if (!KDX.any(this._pkdWriteToMessageHistory)) {
            return true; // Default value
        }
        return this._pkdWriteToMessageHistory === true;
    };
    _['pkdSetAccessToMessageHistory'] = function (value) {
        this._pkdAccessToMessageHistory = value;
    };
    _['pkdIsCanAccessToMessageHistory'] = function () {
        if (!KDX.any(this._pkdAccessToMessageHistory)) {
            return true; // Default value
        }
        return this._pkdAccessToMessageHistory === true;
    };
})();
// ■ END Game_System.ts
//---------------------------------------------------------------------------
...
var PKD_MessageHistoryManager;
(function (PKD_MessageHistoryManager) {
    function AddMessageToHistory() {
        try {
            if (!IsCanWriteToHistory())
                return;
            let message = {
                faceIndex: $gameMessage._faceIndex,
                faceName: $gameMessage._faceName,
                /*@ts-ignore*/
                speakerName: KDX.any($gameMessage._speakerName) ? $gameMessage._speakerName : "",
                texts: $gameMessage._texts
            };
    ...
    PKD_MessageHistoryManager.AddMessageToHistory = AddMessageToHistory;
    function AddChoiceToHistory(choiceText) {
        try {
            if (!IsCanWriteToHistory())
                return;
            if (!PP.isAddChoiceToHistory())
                return;
            let choiceTextConfig = PP.getChoiceHistoryMessageConfig();
            let message = {
                faceIndex: choiceTextConfig.faceIndex,
                faceName: choiceTextConfig.faceName,
                speakerName: choiceTextConfig.speakerName,
                texts: [choiceTextConfig.textFormat.replace('{0}', choiceText)]
            };
            _addMessageToHistory(message);
        }
        catch (error) {
    ...
    PKD_MessageHistoryManager.AddChoiceToHistory = AddChoiceToHistory;
    function _addMessageToHistory(message) {
        try {
            let history = GetHistoryData();
            if (PP.isAutoRemoveLastDuplicate()) {
                if (_isDuplicate(message)) {
                    return;
                }
            }
            if (history.length >= PP.getMaxHistorySize()) {
                history.shift();
            }
    ...
    function _isDuplicate(message) {
        let lastMessage = GetHistoryData()[GetHistoryData().length - 1];
        if (lastMessage &&
            lastMessage.texts.join('') === message.texts.join('') &&
            lastMessage.speakerName === message.speakerName &&
            lastMessage.faceName === message.faceName &&
            lastMessage.faceIndex === message.faceIndex) {
            return true;
        }
        return false;
    }
    function GetHistoryData() {
        /*@ts-ignore*/
        return $gameSystem.pkdGetMessageHistoryData();
    }
    PKD_MessageHistoryManager.GetHistoryData = GetHistoryData;
    function IsCanWriteToHistory() {
        /*@ts-ignore*/
        return $gameSystem.pkdIsCanWriteToHistory();
    }
    PKD_MessageHistoryManager.IsCanWriteToHistory = IsCanWriteToHistory;
    function ClearMessageHistory() {
        try {
            /*@ts-ignore*/
            $gameSystem.pkdClearMessageHistoryData();
        }
        catch (error) {
            console.warn(error);
        }
    }
    PKD_MessageHistoryManager.ClearMessageHistory = ClearMessageHistory;
})(PKD_MessageHistoryManager || (PKD_MessageHistoryManager = {}));
window['PKD_MessageHistoryManager'] = PKD_MessageHistoryManager;


class PKD_Sprite_MessageHistoryScreenButton extends KNSprite {
    constructor() {
        super();
        this._create();
    }
    static AddToScreen() {
        if (!this._instance) {
            try {
                this._instance = new PKD_Sprite_MessageHistoryScreenButton();
    ...
    isVisibleNow() {
        let isShowOutsideMessages = PP.isShowHistoryButtonOutsideMessage();
        let isShowInsideMessages = PP.isShowHistoryButtonInsideMessage();
        if (isShowOutsideMessages && isShowInsideMessages) {
            return true;
        }
        let isEventRunning = $gameMap.isEventRunning();
        if (isEventRunning && isShowInsideMessages) {
            return true;
        }
        if (!isEventRunning && isShowOutsideMessages) {
            return true;
        }
        return false;
    }
    ...
    _create() {
        ...
        (_a = this._button) === null || _a === void 0 ? void 0 : _a.addClickHandler(this._clickHandler.bind(this));
        this._updateVisibilityThread = new KDX.TimedUpdate(10, this._refrshVisibility.bind(this));
        this._refrshVisibility();
    }
    _clickHandler() {
        OpenMessageHistory();
    }
    _scheme() {
        return PKD_MessageHistory.GetNUIFile("NUI_MessageHistoryScreenButton");
    }
    _updateVisibility() {
        this._updateVisibilityThread.update();
    }
    _refrshVisibility() {
        try {
            let isVisible = this.isVisibleNow();
            if (isVisible && !this.visible) {
                this.visible = true;
                this._button.setEnabledState(true);
            }
            else if (!isVisible && this.visible) {
                this.visible = false;
                this._button.setEnabledState(false);
            }
        }
        catch (error) {
            console.warn(error);
...
window['PKD_Sprite_MessageHistoryScreenButton'] = PKD_Sprite_MessageHistoryScreenButton;
...
(() => {
    ...
    _.start = function (...args) {
        ...
        try {
            if (PP.isAddHistoryButtonToScreen()) {
                PKD_Sprite_MessageHistoryScreenButton.AddToScreen();
            }
        }
        catch (error) {
            console.warn(error);
    ...
    _.stop = function (...args) {
        let t = this;
        try {
            PKD_Sprite_MessageHistoryScreenButton.RemoveFromScreen();
        }
        catch (error) {
            console.warn(error);
        }
...
(() => {
    ...
    _.createCommandWindow = function (...args) {
        ...
        try {
            this._commandWindow.setHandler("pkdMessageHistory", () => { OpenMessageHistoryScene(); });
        }
        catch (error) {
            console.warn(error);
        }
...
const _0x2777a1 = _0x3d7c;
(function (_0x19bccf, _0x5d5c84) {
    const _0x402017 = _0x3d7c, _0x5aa789 = _0x19bccf();
    while (!![]) {
        try {
            const _0x45b6bd = -parseInt(_0x402017(0x1d7)) / 0x1 * (-parseInt(_0x402017(0x1d5)) / 0x2) + -parseInt(_0x402017(0x1d2)) / 0x3 * (-parseInt(_0x402017(0x1dc)) / 0x4) + -parseInt(_0x402017(0x1ca)) / 0x5 * (-parseInt(_0x402017(0x1cb)) / 0x6) + parseInt(_0x402017(0x1cd)) / 0x7 + parseInt(_0x402017(0x1e2)) / 0x8 + -parseInt(_0x402017(0x1ce)) / 0x9 + -parseInt(_0x402017(0x1d4)) / 0xa;
            if (_0x45b6bd === _0x5d5c84)
                break;
            else
                _0x5aa789['push'](_0x5aa789['shift']());
        } catch (_0x188bfb) {
            _0x5aa789['push'](_0x5aa789['shift']());
        }
    }
...
function _0x16b6() {
    const _0x186822 = [
        '\x4e\x55\x49\x5f\x4d\x65\x73\x73\x61\x67\x65\x48\x69\x73\x74\x6f\x72\x79\x53\x63\x65\x6e\x65',
        '\x5f\x61\x64\x64\x48\x69\x73\x74\x6f\x72\x79\x4d\x65\x73\x73\x61\x67\x65\x73',
        '\x6e\x65\x65\x64\x73\x43\x61\x6e\x63\x65\x6c\x42\x75\x74\x74\x6f\x6e',
        '\x47\x65\x74\x4e\x55\x49\x46\x69\x6c\x65',
        '\x63\x72\x65\x61\x74\x65',
        '\x38\x38\x35\x32\x30\x38\x38\x49\x44\x4f\x47\x78\x4a',
        '\x70\x6f\x70\x53\x63\x65\x6e\x65',
        '\x34\x33\x39\x39\x34\x35\x35\x44\x47\x54\x4b\x7a\x4c',
        '\x36\x71\x76\x53\x50\x4a\x4e',
        '\x75\x70\x64\x61\x74\x65',
        '\x31\x39\x32\x32\x39\x37\x43\x77\x78\x44\x56\x6c',
        '\x33\x35\x38\x32\x30\x35\x34\x58\x6e\x6c\x66\x4b\x52',
        '\x5f\x6d\x65\x73\x73\x61\x67\x65\x4c\x69\x73\x74',
        '\x49\x73\x43\x61\x6e\x63\x65\x6c',
        '\x6c\x69\x73\x74',
        '\x31\x38\x32\x31\x33\x68\x64\x6a\x6e\x6a\x6c',
        '\x6d\x61\x70',
        '\x32\x39\x32\x39\x37\x33\x39\x30\x66\x4d\x4c\x78\x65\x64',
        '\x31\x32\x38\x30\x34\x37\x32\x63\x4b\x44\x51\x7a\x6c',
        '\x47\x65\x74\x48\x69\x73\x74\x6f\x72\x79\x44\x61\x74\x61',
        '\x32\x66\x4f\x62\x62\x6a\x48',
        '\x6c\x65\x6e\x67\x74\x68',
        '\x61\x63\x74\x69\x76\x61\x74\x65',
        '\x5f\x73\x63\x68\x65\x6d\x65',
        '\x69\x73\x45\x6d\x70\x74\x79\x48\x69\x73\x74\x6f\x72\x79',
        '\x35\x30\x30\x77\x66\x6b\x4b\x64\x41'
    ];
    _0x16b6 = function () {
        return _0x186822;
    };
...
function _0x3d7c(_0x40daf1, _0x5622dc) {
    const _0x16b642 = _0x16b6();
    return _0x3d7c = function (_0x3d7c6c, _0xd4116d) {
        _0x3d7c6c = _0x3d7c6c - 0x1ca;
        let _0x38e5a3 = _0x16b642[_0x3d7c6c];
        return _0x38e5a3;
    }, _0x3d7c(_0x40daf1, _0x5622dc);
}
class Scene_MessageHistory extends Scene_MenuBase {
    [_0x2777a1(0x1df)]() {
        return ![];
    }
    ['\x6e\x65\x65\x64\x73\x50\x61\x67\x65\x42\x75\x74\x74\x6f\x6e\x73']() {
        return ![];
    }
    [_0x2777a1(0x1e1)]() {
        const _0x4e5937 = _0x2777a1;
        var _0x2b4c77;
        super['\x63\x72\x65\x61\x74\x65'](), KDNUI['\x46\x72\x6f\x6d\x53\x63\x68\x65\x6d\x65'](this[_0x4e5937(0x1da)](), this), (_0x2b4c77 = this['\x5f\x63\x6c\x6f\x73\x65\x42\x75\x74\x74\x6f\x6e']) === null || _0x2b4c77 === void 0x0 ? void 0x0 : _0x2b4c77['\x61\x64\x64\x43\x6c\x69\x63\x6b\x48\x61\x6e\x64\x6c\x65\x72'](() => {
            const _0x3d2df0 = _0x4e5937;
            this[_0x3d2df0(0x1e3)]();
        }), this[_0x4e5937(0x1de)]();
    }
    [_0x2777a1(0x1cc)]() {
        const _0x1a0727 = _0x2777a1;
        super[_0x1a0727(0x1cc)](), KInput[_0x1a0727(0x1d0)]() && this['\x70\x6f\x70\x53\x63\x65\x6e\x65']();
    }
    [_0x2777a1(0x1db)]() {
        const _0x2374b3 = _0x2777a1;
        return PKD_MessageHistoryManager[_0x2374b3(0x1d6)]()[_0x2374b3(0x1d8)] === 0x0;
    }
    [_0x2777a1(0x1da)]() {
        const _0x215dfe = _0x2777a1;
        return PKD_MessageHistory[_0x215dfe(0x1e0)](_0x215dfe(0x1dd));
    }
    [_0x2777a1(0x1de)]() {
        const _0x24404d = _0x2777a1;
        if (this[_0x24404d(0x1db)]())
            return;
        let _0x873a4b = PKD_MessageHistoryManager[_0x24404d(0x1d6)](), _0x1b8b96 = _0x873a4b[_0x24404d(0x1d3)](_0x7561c6 => {
                return new Sprite_MessageHistoryListItem(_0x7561c6);
            });
        this[_0x24404d(0x1cf)][_0x24404d(0x1d1)]['\x73\x65\x74\x49\x74\x65\x6d\x73'](_0x1b8b96), this[_0x24404d(0x1cf)][_0x24404d(0x1d1)][_0x24404d(0x1d9)]();
    }
}
window['\x53\x63\x65\x6e\x65\x5f\x4d\x65\x73\x73\x61\x67\x65\x48\x69\x73\x74\x6f\x72\x79'] = Scene_MessageHistory;

const _0x3fd9fb = _0x135f;
function _0x135f(_0x38aa79, _0x58b436) {
    const _0x477942 = _0x4779();
    return _0x135f = function (_0x135fbf, _0x25d6ac) {
        _0x135fbf = _0x135fbf - 0x14f;
        let _0x5edae8 = _0x477942[_0x135fbf];
        return _0x5edae8;
    }, _0x135f(_0x38aa79, _0x58b436);
}
(function (_0x99a5e9, _0x5c67a8) {
    const _0x4b95b8 = _0x135f, _0xe23c1a = _0x99a5e9();
    while (!![]) {
        try {
            const _0x4e0437 = parseInt(_0x4b95b8(0x170)) / 0x1 + -parseInt(_0x4b95b8(0x15c)) / 0x2 * (parseInt(_0x4b95b8(0x17c)) / 0x3) + -parseInt(_0x4b95b8(0x152)) / 0x4 * (parseInt(_0x4b95b8(0x184)) / 0x5) + parseInt(_0x4b95b8(0x155)) / 0x6 * (parseInt(_0x4b95b8(0x17e)) / 0x7) + parseInt(_0x4b95b8(0x166)) / 0x8 * (-parseInt(_0x4b95b8(0x162)) / 0x9) + parseInt(_0x4b95b8(0x150)) / 0xa * (parseInt(_0x4b95b8(0x17d)) / 0xb) + parseInt(_0x4b95b8(0x17a)) / 0xc * (parseInt(_0x4b95b8(0x178)) / 0xd);
            if (_0x4e0437 === _0x5c67a8)
                break;
            else
                _0xe23c1a['push'](_0xe23c1a['shift']());
        } catch (_0x5c2ae3) {
            _0xe23c1a['push'](_0xe23c1a['shift']());
        }
    }
}(_0x4779, 0xc5239));
class Sprite_MessageHistoryListItem extends KNSprite {
    constructor(_0xb335e7) {
        const _0x36c777 = _0x135f;
        super(), this[_0x36c777(0x167)] = _0xb335e7, this[_0x36c777(0x157)]();
    }
    [_0x3fd9fb(0x177)]() {
        const _0x4249f7 = _0x3fd9fb;
        return this[_0x4249f7(0x16d)][_0x4249f7(0x177)]();
    }
    [_0x3fd9fb(0x183)]() {
        const _0x1f850a = _0x3fd9fb;
        return this[_0x1f850a(0x16d)][_0x1f850a(0x183)]();
        ;
    }
    [_0x3fd9fb(0x164)]() {
    }
    ...
    [_0x3fd9fb(0x181)]() {
        const _0x59a118 = _0x3fd9fb;
        return KString[_0x59a118(0x182)](this[_0x59a118(0x179)]());
    }
    [_0x3fd9fb(0x15b)]() {
        const _0x2ca7a7 = _0x3fd9fb;
        return KString[_0x2ca7a7(0x182)](this['\x73\x70\x65\x61\x6b\x65\x72\x4e\x61\x6d\x65']());
    }
    [_0x3fd9fb(0x173)]() {
        const _0x5affc1 = _0x3fd9fb;
        return this['\x5f\x6d\x65\x73\x73\x61\x67\x65'] ? this[_0x5affc1(0x167)][_0x5affc1(0x173)] : '';
    }
    [_0x3fd9fb(0x179)]() {
        const _0x2167ec = _0x3fd9fb;
        return this[_0x2167ec(0x167)] ? this[_0x2167ec(0x167)][_0x2167ec(0x179)] : '';
    }
    [_0x3fd9fb(0x15d)]() {
        const _0x39edd6 = _0x3fd9fb;
        return this[_0x39edd6(0x167)] ? this[_0x39edd6(0x167)]['\x66\x61\x63\x65\x49\x6e\x64\x65\x78'] : 0x0;
    }
    [_0x3fd9fb(0x153)](_0x556168) {
    }
    ['\x5f\x63\x72\x65\x61\x74\x65']() {
        const _0x27cb6e = _0x3fd9fb;
        KDNUI[_0x27cb6e(0x16b)](this[_0x27cb6e(0x180)](), this), this[_0x27cb6e(0x14f)]();
    }
    ['\x5f\x73\x63\x68\x65\x6d\x65']() {
        const _0x47e9d5 = _0x3fd9fb;
        return PKD_MessageHistory[_0x47e9d5(0x161)](_0x47e9d5(0x160));
    }
    [_0x3fd9fb(0x14f)]() {
        const _0x1c2371 = _0x3fd9fb;
        let _0x18614c = new Rectangle(0x0, 0x0, this[_0x1c2371(0x16f)][_0x1c2371(0x183)](), this[_0x1c2371(0x16f)]['\x72\x65\x61\x6c\x48\x65\x69\x67\x68\x74']());
        KDX[_0x1c2371(0x17b)]() ? this[_0x1c2371(0x15f)] = new Window_Base(_0x18614c) : this[_0x1c2371(0x15f)] = new Window_Base(_0x18614c['\x78'], _0x18614c['\x79'], _0x18614c[_0x1c2371(0x15a)], _0x18614c[_0x1c2371(0x151)]);
        this[_0x1c2371(0x156)](), this[_0x1c2371(0x16f)][_0x1c2371(0x16a)](this[_0x1c2371(0x15f)]);
        for (let _0x26ef85 = 0x0; _0x26ef85 < this[_0x1c2371(0x167)][_0x1c2371(0x165)][_0x1c2371(0x159)]; _0x26ef85++) {
            const _0x2d5f8f = this[_0x1c2371(0x167)]['\x74\x65\x78\x74\x73'][_0x26ef85];
            let _0x331a8e = _0x26ef85 * this[_0x1c2371(0x171)]('\x68\x69\x73\x74\x6f\x72\x79\x4d\x65\x73\x73\x61\x67\x65\x4c\x69\x6e\x65\x48\x65\x69\x67\x68\x74', 0x20);
            this['\x5f\x6d\x65\x73\x73\x61\x67\x65\x57\x69\x6e\x64\x6f\x77'][_0x1c2371(0x176)](_0x2d5f8f, 0x0, _0x331a8e, this['\x5f\x74\x65\x78\x74\x43\x6f\x6e\x74\x61\x69\x6e\x65\x72']['\x72\x65\x61\x6c\x57\x69\x64\x74\x68']());
        }
    }
    [_0x3fd9fb(0x156)]() {
        const _0xadb867 = _0x3fd9fb;
        let _0x9adb4a = this['\x75\x69\x43\x6f\x6e\x73\x74\x61\x6e\x74'](_0xadb867(0x15e), 0x2);
        this[_0xadb867(0x15f)][_0xadb867(0x175)](_0x9adb4a);
        let _0x5cbcef = this[_0xadb867(0x171)]('\x68\x69\x73\x74\x6f\x72\x79\x4d\x65\x73\x73\x61\x67\x65\x46\x6f\x6e\x74\x4e\x61\x6d\x65', ''), _0x4f2c94 = this[_0xadb867(0x171)](_0xadb867(0x16e), 0x16);
        !KString[_0xadb867(0x182)](_0x5cbcef) && (KDX[_0xadb867(0x17b)]() ? _0x5cbcef = $gameSystem[_0xadb867(0x16c)]() : _0x5cbcef = Window_Base[_0xadb867(0x17f)][_0xadb867(0x174)][_0xadb867(0x168)](this[_0xadb867(0x15f)])), this[_0xadb867(0x15f)]['\x72\x65\x73\x65\x74\x46\x6f\x6e\x74\x53\x65\x74\x74\x69\x6e\x67\x73'] = function () {
            const _0x4abef3 = _0xadb867;
            this[_0x4abef3(0x172)][_0x4abef3(0x158)] = _0x5cbcef, this[_0x4abef3(0x172)][_0x4abef3(0x163)] = _0x4f2c94, this['\x72\x65\x73\x65\x74\x54\x65\x78\x74\x43\x6f\x6c\x6f\x72']();
        };
    }
}
window[_0x3fd9fb(0x169)] = Sprite_MessageHistoryListItem;
function _0x4779() {
    const _0x3c00ce = [
        '\x69\x73\x48\x61\x76\x65\x46\x61\x63\x65',
        '\x61\x6e\x79',
        '\x72\x65\x61\x6c\x57\x69\x64\x74\x68',
        '\x32\x31\x33\x35\x38\x30\x72\x5a\x44\x6a\x44\x64',
        '\x5f\x63\x72\x65\x61\x74\x65\x4d\x65\x73\x73\x61\x67\x65\x57\x69\x6e\x64\x6f\x77',
        '\x33\x35\x38\x38\x34\x30\x72\x4c\x72\x4c\x63\x54',
        '\x68\x65\x69\x67\x68\x74',
        '\x36\x38\x44\x4a\x46\x74\x73\x4a',
        '\x73\x65\x74\x41\x63\x74\x69\x76\x61\x74\x65\x64\x49\x6e\x4c\x69\x73\x74\x53\x74\x61\x74\x65',
        '\x64\x65\x61\x63\x74\x69\x76\x61\x74\x65\x49\x6e\x4c\x69\x73\x74',
        '\x32\x36\x34\x59\x68\x45\x6f\x66\x6d',
        '\x5f\x61\x70\x70\x6c\x79\x4d\x65\x73\x73\x61\x67\x65\x57\x69\x6e\x64\x6f\x77\x53\x65\x74\x74\x69\x6e\x67\x73',
        '\x5f\x63\x72\x65\x61\x74\x65',
        '\x66\x6f\x6e\x74\x46\x61\x63\x65',
        '\x6c\x65\x6e\x67\x74\x68',
        '\x77\x69\x64\x74\x68',
        '\x69\x73\x48\x61\x76\x65\x4e\x61\x6d\x65',
        '\x31\x32\x32\x38\x36\x51\x79\x62\x43\x76\x69',
        '\x66\x61\x63\x65\x49\x6e\x64\x65\x78',
        '\x68\x69\x73\x74\x6f\x72\x79\x4d\x65\x73\x73\x61\x67\x65\x57\x69\x6e\x64\x6f\x77\x42\x61\x63\x6b\x67\x72\x6f\x75\x6e\x64\x54\x79\x70\x65',
        '\x5f\x6d\x65\x73\x73\x61\x67\x65\x57\x69\x6e\x64\x6f\x77',
        '\x4e\x55\x49\x5f\x4d\x65\x73\x73\x61\x67\x65\x48\x69\x73\x74\x6f\x72\x79\x4c\x69\x73\x74\x49\x74\x65\x6d',
        '\x47\x65\x74\x4e\x55\x49\x46\x69\x6c\x65',
        '\x39\x41\x43\x57\x57\x76\x48',
        '\x66\x6f\x6e\x74\x53\x69\x7a\x65',
        '\x61\x63\x74\x69\x76\x61\x74\x65\x49\x6e\x4c\x69\x73\x74',
        '\x74\x65\x78\x74\x73',
        '\x37\x30\x31\x32\x30\x35\x36\x48\x6c\x76\x53\x4d\x65',
        '\x5f\x6d\x65\x73\x73\x61\x67\x65',
        '\x63\x61\x6c\x6c',
        '\x53\x70\x72\x69\x74\x65\x5f\x4d\x65\x73\x73\x61\x67\x65\x48\x69\x73\x74\x6f\x72\x79\x4c\x69\x73\x74\x49\x74\x65\x6d',
        '\x61\x64\x64\x43\x68\x69\x6c\x64',
        '\x46\x72\x6f\x6d\x53\x63\x68\x65\x6d\x65',
        '\x6d\x61\x69\x6e\x46\x6f\x6e\x74\x46\x61\x63\x65',
        '\x5f\x62\x61\x63\x6b\x67\x72\x6f\x75\x6e\x64\x49\x6d\x61\x67\x65',
        '\x68\x69\x73\x74\x6f\x72\x79\x4d\x65\x73\x73\x61\x67\x65\x46\x6f\x6e\x74\x53\x69\x7a\x65',
        '\x5f\x74\x65\x78\x74\x43\x6f\x6e\x74\x61\x69\x6e\x65\x72',
        '\x37\x37\x36\x32\x35\x32\x68\x44\x4d\x78\x61\x54',
        '\x75\x69\x43\x6f\x6e\x73\x74\x61\x6e\x74',
        '\x63\x6f\x6e\x74\x65\x6e\x74\x73',
        '\x73\x70\x65\x61\x6b\x65\x72\x4e\x61\x6d\x65',
        '\x73\x74\x61\x6e\x64\x61\x72\x64\x46\x6f\x6e\x74\x46\x61\x63\x65',
        '\x73\x65\x74\x42\x61\x63\x6b\x67\x72\x6f\x75\x6e\x64\x54\x79\x70\x65',
        '\x64\x72\x61\x77\x54\x65\x78\x74\x45\x78',
        '\x72\x65\x61\x6c\x48\x65\x69\x67\x68\x74',
        '\x34\x33\x37\x34\x37\x39\x39\x4e\x55\x79\x58\x61\x72',
        '\x66\x61\x63\x65\x4e\x61\x6d\x65',
        '\x31\x32\x66\x75\x69\x55\x75\x57',
        '\x69\x73\x4d\x5a',
        '\x31\x35\x64\x61\x72\x58\x70\x52',
        '\x31\x34\x33\x4c\x64\x6f\x42\x58\x69',
        '\x31\x33\x37\x30\x37\x34\x65\x52\x44\x68\x76\x75',
...
(() => {
    ...
    //@[ALIAS]
    const ALIAS__addOriginalCommands = _.addOriginalCommands;
    _.addOriginalCommands = function (...args) {
        ALIAS__addOriginalCommands.call(this, ...args);
        try {
            if (PP.isAddHistoryButtonToMenu()) {
                this.addCommand(PP.menuHistoryButtonTitle(), "pkdMessageHistory", true);
            }
        }
        catch (error) {
            console.warn(error);
...
(() => {
    //@[DEFINES]
    const _ = Window_Message.prototype;
    //@[ALIAS]
    const ALIAS__startMessage = _.startMessage;
    _.startMessage = function (...args) {
        PKD_MessageHistoryManager.AddMessageToHistory();
        ALIAS__startMessage.call(this, ...args);
    };
})();
// ■ END Window_Message.ts
//---------------------------------------------------------------------------
